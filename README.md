...
- Generative AI and automation specialist focused on applied business solutions.
- Experience with systems integration, APIs, dashboards and process optimization.
- Background in Computer Science, cybersecurity, project management, data and software development.
- Building solutions with Python, TypeScript, Node.js, React, SQL, Power BI and cloud platforms.
- Interested in international and remote opportunities involving AI, data, automation, software and IT governance.
...
|---|---|---|
| Artificial Intelligence | AI assistants, RAG, agents and intelligent workflows | LLMs, OpenAI API, prompt engineering, embeddings |
| Automation | Business process automation and system orchestration | Python, Node.js, APIs, n8n |
| Data & BI | Data analysis, KPIs and decision support | SQL, Power BI, Python, PostgreSQL |
| Software Engineering | Web applications and backend services | TypeScript, JavaScript, React, Express, REST APIs |
| Infrastructure & Cloud | Systems, networks and cloud environments | Windows Server, Linux, Azure, AWS, OCI |
| Cybersecurity | Risk management, controls and defensive security | IAM, firewalls, governance, ISO 27001 concepts |
...
|---|---|---|
| [GenAI Risk Analyst](https://github.com/Sembla/genai-risk-analyst) | Generative AI solution for credit risk analysis using RAG and LLMs. | Python · RAG · LLM |
| [GenAI Risk Analyst Pro](https://github.com/Sembla/GenAI-Risk-Analyst-Pro) | AI assistant for credit, risk and compliance analysis with contextual document retrieval. | Python · RAG · OpenAI API |
| [Data Insight AI](https://github.com/Sembla/Data-insight-ai) | AI-powered data analysis assistant with natural-language queries, KPIs and an interactive dashboard. | Python · Data Analysis · AI |
| [Engineering BOM Intelligence](https://github.com/Sembla/Engineering-BOM-Intelligence) | Intelligent solution for engineering and bill-of-materials analysis. | Python · Engineering Data |
| AI ERP Assistant | Business assistant for orders, inventory, production and operational insights. | TypeScript · Node.js · React · SQL |
...
| MBA | Cybersecurity and Risk Management |
| MBA | Project Management |
| Postgraduate Program | Artificial Intelligence and Data Science |
| Postgraduate Program | Systems Analysis and Development |
...
|---|---|---|
| 01 | Expand practical AI and RAG projects | In progress |
| 02 | Strengthen cloud, DevOps and deployment skills | In progress |
| 03 | Develop security, governance and risk projects | In progress |
| 04 | Publish technical documentation and case studies | Planned |
| 05 | Contribute to international open-source projects | Planned |
